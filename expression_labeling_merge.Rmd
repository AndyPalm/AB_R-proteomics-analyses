...
target_file_path <- here::here("data", "target_proteins_JJMack.csv")
```
...
df2_clean <- df2.comparison %>%
  filter(Label == "DF_vs_UF") %>%  #make sure this matches the comparison designation in your expression dataset
...
ggsave(file.path(output_dir, "Labeling_vs_normExpression_actin-cytoskeletal-labels1.pdf"), plot = p_fc, width = 12, height = 12)
```
