...
# 2. Filter Experiment 1 (Treatments) - Terminal Safe Version
...
ggsave(file.path(output_dir, "Labeling_vs_Expression_labels_10x10.pdf"), plot = p_fc, width = 10, height = 10)
```
...
```{r}
ggsave(file.path(output_dir, "HAEC_expression-labeling_ANCOVA-scatter_labels.pdf"), plot = p_scatter, width = 6, height = 6)
