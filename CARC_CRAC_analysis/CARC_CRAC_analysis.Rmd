...
date: "2025-07-29"
R_version: "4.4.2"
description: "Identifies and characterizes CARC and CRAC cholesterol-recognition motifs in the human proteome. Analyzes motif positions, structural overlaps with transmembrane helices and beta-strands, and generates comprehensive statistics."
---
...
# --- DATA PROCESSING: Define motif analysis functions ---

# Function to parse structural features (helices or strands) from UniProt annotation strings
...
# CRAC pattern: [LV](X0-5)Y(X0-5)[RK]
# CARC pattern: [RK](X0-5)[YF](X0-5)[LV]
...
# Function to get detailed structural overlap information for a specific protein
...
```{r analysis}
# --- ANALYSIS: Run proteome-wide CARC/CRAC motif analysis ---
...
# --- DATA LOADING: Load previously computed results ---
results <- read.csv("AB_human-proteome_CARC-CRAC_analysis_29july25.csv")
```

```{r analysis_summary}
# --- ANALYSIS: Summary of structural overlaps ---
# Uncomment to run:
